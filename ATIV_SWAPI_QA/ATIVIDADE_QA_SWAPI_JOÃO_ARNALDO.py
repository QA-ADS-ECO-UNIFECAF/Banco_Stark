...
# Versão do aluno — com scripts base e respostas
# Manus AI
...
print("Respostas: Status 200, Nome: Bib Fortuna, Altura: 180, Olhos: pink, JSON Completo: Sim\n")
...
print("Status Code:", response.status_code)
print(json.dumps(dados, indent=4, ensure_ascii=False))
print("Respostas: Status 200, Nome: San Hill, Altura: 191, Olhos: gold, JSON Completo: Sim\n")
...
print("Status Code:", response.status_code)
print(json.dumps(dados, indent=4, ensure_ascii=False))
print("Respostas: Status 200, Nome: Felucia, Clima: hot, humid, Terreno: fungus forests, População: 8500000, JSON Completo: Sim\n")
...
print("Status Code:", response.status_code)
print(json.dumps(dados, indent=4, ensure_ascii=False))
print("Respostas: Status 200, Nome: B-wing, Modelo: A/SF-01 B-wing starfighter, Fabricante: Slayn & Korpil, Velocidade: 950, JSON Completo: Sim\n")
