# -*- coding: utf-8 -*-
"""Raphael_Neves_Carvalho-ADS5NB_QA_Banco_do_Stark.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1IvWGTPaWBHGW26004XwpLu1h6OfWLbyS
...
**ID:** CT-001  
**Título/Objetivo:**  Digitar para criar conta e dar erro de conta ja existe
**Pré-condição:** erro, conta ja criada

**Passos:**  
1. Inicie o banco
2. Crie a conta mesmo ja existindo - banco.criar_conta('pepper')
3. Resultado

**Resultado esperado:**  ERRO - Conta já existe: pepper
**Resultado obtido:**  ERRO - Conta já existe: pepper
...
**ID:** CT-002  
**Título/Objetivo:**  Criação de deposito de valor
**Pré-condição:**  Ser feito com exito o depósito
**Passos:**  
1.  Iniciar o banco
2.  Fazer o deposito - banco.depositar('tony', 5000)
3.  Resultado
**Resultado esperado:** OK - Depósito realizado: 5000  
**Resultado obtido:**  OK - Depósito realizado: 5000
**Status (Pass/Fail):**  Pass
**Evidência:**  
=== DEPÓSITOS ===
...
**ID:** CT-003  
**Título/Objetivo:**  Sacar valor - conta tony
**Pré-condição:**  Necessário ser feito o saque com o saldo suficiente
**Passos:**  
1.  Iniciar banco
2.  Ser feito o saque - banco.sacar('tony', 100)
3.  Resultado

**Resultado esperado:**  OK - Saque realizado: 100,
SALDO tony = 14200.0
**Resultado obtido:**  OK - Saque realizado: 100,
SALDO tony = 14200.0
**Status (Pass/Fail):**  Pass
**Evidência:**  
=== SAQUE ===
...
## Template — Bug Report
**Título:**  Deposito negativo sem ter um bloqueio
**Severidade (Baixa/Média/Alta):**  Alta
**Prioridade (Baixa/Média/Alta):**  ALta
**Ambiente:** Google Colab / Python 3.x / Banco do Stark  

**Descrição:**  
Ser feito deposito negativo sem ser feito o bloqueio

**Passos para reproduzir:**  
1.  Criar conta
2.  Depositar valor negativo
3.  Resultado do saldo

**Resultado esperado:**  
**Resultado obtido:**  
**Evidência:**  === DEPÓSITOS ===
OK - Depósito realizado: -100
**Impacto/Risco:** Risco de ter erro ou inconsistencia na conta

## Template — Bug Report
**Título:**  Falha em tipo de diferença das letra das contas
**Severidade (Baixa/Média/Alta):**  Baixa
**Prioridade (Baixa/Média/Alta):**  Baixa
**Ambiente:** Google Colab / Python 3.x / Banco do Stark  

**Descrição:**  
Sistema diferenciando letra minuscula da maiuscula no nome conta, não a encontrando

**Passos para reproduzir:**  
1.  Criar uma conta escrito uma conta "tony"
2.  Acessar o saldo com o nome "Tony"


**Resultado esperado:**  Localizar mesmo com o nome em maiusculo
**Resultado obtido:**  
**Evidência:**  banco.saldo_atual('Tony') = banco.saldo_atual('Tony')
**Impacto/Risco:**  Falha e confusão no sistema

## Template — Bug Report
**Título:**  Deposito sendo feito zerado
**Severidade (Baixa/Média/Alta):**  Baixa
**Prioridade (Baixa/Média/Alta):**  Baixa
**Ambiente:** Google Colab / Python 3.x / Banco do Stark  

**Descrição:**  
Deposito sendo feito zerado para uma conta.

**Passos para reproduzir:**  
1.  Crie uma conta
2.  Faça um deposito zerado
3.  Resultado

**Resultado esperado:**  Dar erro dizendo que está zerado o valor
**Resultado obtido:**  Teste N1 - Depósito com valor zero
