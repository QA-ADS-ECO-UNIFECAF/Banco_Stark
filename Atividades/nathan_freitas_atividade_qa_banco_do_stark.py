# -*- coding: utf-8 -*-
"""Nathan Freitas Atividade_QA_Banco_do_Stark.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1B09EP74-5MZJUNmiRli9qA_k_ExCLnLb
...
print('\n=== DEPÓSITOS ===')
banco.depositar('Nathan Freitas', 1000)
...
print('\n=== SAQUE ===')
banco.sacar('Nathan Freitas', 200)
banco.saldo_atual('tony')
...
banco.transferir('tony', 'Nathan Freitas', -500)
...
**Resultado esperado:** Criar usuario com sucesso

**Resultado obtido:**  OK - Conta criada para: Nathan Freitas
**Status (Pass/Fail):** Pass

**Evidência:**OK - Conta criada para: Nathan Freitas

## Template — Caso de Teste 2
**ID:** CT-002  
**Título/Objetivo:**  Deposito
**Pré-condição:**  Saldo na conta
**Passos:**  
1.  Iniciar o Banco
2.  chamar funcao
3.  deposito em conta existente
**Resultado esperado:**  Deposito executado com sucesso
...
**ID:** CT-003  
**Título/Objetivo:**  Saque

**Pré-condição:**  Saldo em conta
...
**Evidência:**  Depósito com valor zero
...
**Descrição:**  transferencia com valor negativo

**Passos para reproduzir:**  
1.  banco rodando
2.  ter conta criada
3.  nao ter saldo correto com o valor que deseja transferir

**Resultado esperado:**  erro na transacao
**Resultado obtido:**  
**Evidência:**  banco.transferir('tony', 'Nathan Freitas', -500)
**Impacto/Risco:**  alto

## Template — Bug Report
**Título:**  criar conta com nome vazio
**Severidade (Baixa/Média/Alta):**  alto
**Prioridade (Baixa/Média/Alta):**  alto
**Ambiente:** Google Colab / Python 3.x / Banco do Stark  

**Descrição:**  criar conta com nome vazio

**Passos para reproduzir:**  
1.  banco iniciado
2.  cadastrar uma nova conta deixando o nome em branco
3.  

**Resultado esperado:**  nao criar
