...
Original file is located at
    https://colab.research.google.com/drive/1FcjNwniisFGjQ1fGfLfnEIGVuIhU937J
...
**ID:** CT-001  
**Título/Objetivo:**   validar deposito com valor 0

**Pré-condição:** conta tony ja foi criada

**Passos:**  


1. identificar a conta de destino ativa para o titular 'tony'
2. chamar a função banco.depositar('tony', 0)  
3. consultar o extrato ou saldo final da conta para verificar alterações


**Resultado esperado:** deve dar uma mensagem de erro e nao alterar o saldo (Depósito: valor deve ser > 0)
...
**ID:** CT-002  
**Título/Objetivo:**  validar depósito de valor negativo

**Pré-condição:** conta tony ja foi criada

**Passos:**  
1.  acessar banco stark
2.  chamar a funçao depositar com o valor -100 pra conta tony
3.  validar se o saldo da conta sofreu uma reduçao que nao podia por causa da funçao saldo_atual

**Resultado esperado:**  o sistema deve validar o valor de entrada e negar os depósitos negativos

**Resultado obtido:**  o sistema processou o valor negativo e reduziu o saldo total do titular
...
**Pré-condição:**  a conta de origem 'tony' deve ter saldo suficiente
**Passos:**  

1.  acessar a parte de transferencias do banco stark
2.  tentar fazer uma transferência da conta 'tony' para uma conta inexistente
, por exemplo:'thor' com o valor de 50

3.  verificar a mensagem de retorno do sistema e se o saldo da conta 'tony' continuam sem alteraçoes

**Resultado esperado:**  o sistema deve exibir o erro "Conta destino não encontrada" e impedir o débito no saldo da conta de origem
...
**Descrição:** o sistema permite a entrada de valor zero na função de depósito, o que não deveria ocorrer de acordo com os requisitos de negócio


**Passos para reproduzir:**  
1.  criar uma conta qualquer (exemplo: 'pepper')
2.  executar a função banco.depositar('pepper', 0)
3.  observar a mensagem de sucesso indevida no console

**Resultado esperado:**  O sistema deve bloquear depósitos que não sejam estritamente maiores que 0

**Resultado obtido:**  O sistema exibe "OK - Depósito realizado: 0"

**Evidência:**  Evidência: OK - Depósito realizado: 0

**Impacto/Risco:** impacto baixo na integridade, mas polui o extrato com transações inúteis e fere a regra de negócio estabelecida
