# -*- coding: utf-8 -*-
"""atividade_qa_partes_04_05_banco_do_stark.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1-0lMd9XFWnPv0_URNA4NFGUcFtFdc0UO
...
print('\nTeste N8 - Criar conta já existente sem verificação de caixa alta')
banco.criar_conta('TONY')
...
**ID:** CT-001  
**Título/Objetivo:**  Teste N7 - Transferência para si mesmo

**Pré-condição:**  Banco Funcionando, Conta criada

**Passos:**  
1.  iniciar o banco
2.  realizar transferencia para si mesmo

**Resultado esperado:**  Não é possivel efetuar transações para si mesmo

**Resultado obtido:**  OK - Transferência realizada: 50
...
**ID:** CT-002  
**Título/Objetivo:**  Teste N8 - Criar conta já existente sem verificação de caixa alta

**Pré-condição:**  Banco rodando, conta criada

**Passos:**  
1.  iniciar o banco
2.  realizr a criação de uma conta com nome igual a outra

**Resultado esperado:**  Nome já existente

**Resultado obtido:**  OK - Conta criada para: TONY

**Status (Pass/Fail):**  Fail

**Evidência:** OK - Conta criada para: TONY
...
**Passos:**  
1.  iniciar o banco
2.  realizar um saque com valor maior que o saldo
...
## Template — Bug Report
**Título:**  Teste N7 - Transferência para si mesmo
...
**Descrição:**  Usuário consegue fazer uma tranferência para si mesmo

**Passos para reproduzir:**  
1.  inicializar o banco
2.  realizar transferencia

**Resultado esperado:**  Não é possivel executar tranferencias para si mesmo

**Resultado obtido:**  OK - Transferência realizada: valor

**Evidência:**  OK - Transferência realizada: 50

**Impacto/Risco:**  baixo, já que há a verificação do saldo
